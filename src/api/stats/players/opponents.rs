...
pub struct PlayerStatsByOpponent<'a> {
...
impl PlayerStatsByOpponent<'_> {
    /// Create a builder for this endpoint
    pub fn builder<'a>() -> PlayerStatsByOpponentBuilder<'a> {
        PlayerStatsByOpponentBuilder::default()
    }
}

impl Endpoint for PlayerStatsByOpponent<'_> {
    fn endpoint(&self) -> Cow<'static, str> {
        "/stats/players/opponents".into()
    }
